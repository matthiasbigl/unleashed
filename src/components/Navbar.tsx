            ...
            <div className="flex flex-row items-center justify-end w-1/2 h-full px-6 gap-x-5">
              ...
              */}{
              !user.isSignedIn ? (
                ...
                <div className="
                flex  flex-row items-center justify-end w-full h-full gap-x-4">
                  <Link className='flex flex-row items-center-center gap-2 text-lg py-1 px-2  rounded-md
                  hover:scale-105 hover:shadow-lg hover:bg-zinc-800/50 transition duration-150 ease-in-out' href={"/profile"}>
