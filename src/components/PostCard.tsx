...
export default function PostCard(props: PostWithImagesAndUser) {
  ...
  return (
    <div className="flex flex-col md:rounded-md md:border border-b border-neutral-800 bg-zinc-800/30 md:w-1/2 lg:w-1/3 w-screen ">
      ...
      <div className="flex flex-row items-center justify-between px-4 py-2">
        <div className="flex flex-row items-center gap-x-4">
          ...
          <button className="focus:outline-none">
            <BsFillSendFill className="text-gray-500 text-2xl" />
          </button>
        </div>
        <button className="focus:outline-none">
