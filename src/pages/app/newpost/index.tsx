...
export default function NewPost(): JSX.Element {
  ...
  return (
    <AppLayout>
      ...
      <div className="w-screen min-h-screen md:min-h-fit md:w-1/2  flex flex-col pt-40 md:p-4 items-center md:justify-center md:rounded-md md:border border-neutral-800 bg-zinc-800/30 gap-4 p-5">
        ...
        >
          <div
            {...getRootProps({
              className: "w-full h-40 p-4 flex flex-col items-center justify-center border-2 border-dashed border-gray-400 rounded-md",
            })}
          >
            <input {...getInputProps()} />
